...
namespace AdaptiveConsole
{
    ...
    /// </summary>
    public class ArgumentMissingException : AdaptiveConsoleException
    {
        #region Constructors
        /// <summary>
        ...
        public ArgumentMissingException(string format, params object[] arguments) : base(string.Format(format, arguments)) { }
        #endregion
    }
}
